        ...
        <form action="{{ route('user.new') }}" method="POST">
            ...
            <div class="grid gap-6 mb-6 sm:grid-cols-2">
                ...
                <div class="col-span-2 sm:col-span-1">
                    <label for="name" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">Nom</label>
                ...
                <!-- Email -->
                <div class="col-span-2 sm:col-span-1">
                    <label for="email" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">Adresse email</label>
                ...
                <div class="col-span-2">
                    <label for="password" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">Mot de passe</label>
                ...
                <!-- Service -->
                <div class="col-span-2 sm:col-span-1">
                    <label for="service" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">Service</label>
                ...
                <!-- Rôle -->
                <div class="col-span-2">
                    <label class="block text-sm font-medium text-gray-900 dark:text-white mb-2">Choisissez un rôle</label>
                    <div class="flex flex-wrap gap-4">
                        ...
                        <label class="flex items-center space-x-3">
                            ...
                            <span class="text-sm font-medium text-gray-900 dark:text-white">{{ $role->nom }}</span>
                        </label>
                        @endforeach
                    </div>
                    @error('role')
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center mt-6">
                <a href="{{ route('login') }}" class="text-sm text-blue-700 hover:underline dark:text-blue-400">Déjà un compte ?</a>
                <button type="submit"
