            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <input wire:model="file"
                        ...
                        accept="application/pdf, text/csv, application/application/msword, application/vnd.openxmlformats-officedocument.wordprocessingml.document, image/jpeg, image/png, application/vnd.ms-powerpoint, application/vnd.openxmlformats-officedocument.presentationml.presentation, text/plain, application/vnd.ms-excel, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
                        required />
                </div>
                ...
                <ul
                    ...
                    <li class=" flex flex-col gap-3 px-3 py-2 border-b dark:border-gray-600">
                        <div>
                            ...
                            <label for="service-checkbox-{{ $service->id }}" class="text-gray-900 dark:text-gray-300">
                                {{ $service->nom }}
                            </label>
                        </div>
